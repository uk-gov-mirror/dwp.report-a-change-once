...
router.post(`${baseUrl}/report-a-change-once/when-did-you-move-to-your-new-address`, function (req, res) {
  ...
  // Check if month field is 31
  if (month === "31") {
    return res.redirect(`${baseUrl}/report-a-change-once/errors/when-did-you-move-to-your-new-address`)
  }
...
router.post(`${baseUrl}/report-a-change-once/errors/when-did-you-move-to-your-new-address`, function(req, res) {
  const day = req.body["move-date-day"]
  const month = req.body["move-date-month"]
  const year = req.body["move-date-year"]
...
router.post(`${baseUrl}/report-a-change-once/address/select-your-new-address`, function(req, res) {
  ...
  // Check whether the variable matches a condition
  if (selectAddress == "101"){
    // Send user to next page
    res.redirect(`${baseUrl}/report-a-change-once/you-cannot-use-this-service/care-home`)
  } else {
    // Send user to ineligible page
    res.redirect(`${baseUrl}/report-a-change-once/address/confirm-new-address`)
  }

})

router.post(`${baseUrl}/report-a-change-once/address/confirm-new-address`, function(req, res) {
    res.redirect(`${baseUrl}/report-a-change-once/check-your-answers/lookup`)
})

router.post(`${baseUrl}/report-a-change-once/check-your-answers/lookup`, function(req, res) {
    res.redirect(`${baseUrl}/report-a-change-once/we-have-received-your-change-of-address/lookup`)
})

router.post(`${baseUrl}/report-a-change-once/we-have-received-your-change-of-address/lookup`, function(req, res) {
    res.redirect(`${baseUrl}/customer-account/account-home`)
})

router.post(`${baseUrl}/report-a-change-once/we-have-received-your-change-of-address/manual`, function(req, res) {
    res.redirect(`${baseUrl}/customer-account/account-home`)
})
...
router.post(`${baseUrl}/report-a-change-once/have-you-moved-into-a-care-home-or-hospital`, function (req, res) {
  ...
  if (careHome == "no"){
    // Send user to next page
    res.redirect(`${baseUrl}/report-a-change-once/address/enter-new-address-manually`)
  } else {
    // Send user to ineligible page
    res.redirect(`${baseUrl}/report-a-change-once/you-cannot-use-this-service/care-home`)
  }
...
router.post(`${baseUrl}/report-a-change-once/address/enter-new-address-manually`, function(req, res) {
    res.redirect(`${baseUrl}/report-a-change-once/address/confirm-new-address-manual`)
})

router.post(`${baseUrl}/report-a-change-once/address/confirm-new-address-manual`, function(req, res) {
    res.redirect(`${baseUrl}/report-a-change-once/check-your-answers/manual`)
})

router.post(`${baseUrl}/report-a-change-once/check-your-answers/manual`, function(req, res) {
    res.redirect(`${baseUrl}/report-a-change-once/we-have-received-your-change-of-address/manual`)
})
